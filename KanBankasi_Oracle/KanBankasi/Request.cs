...
namespace KanBankasi
{
    public partial class Request : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            {
                String sorgu1 = "insert into TalepBilgi (talepNo, tcNo, aciklama, tarih, durum) values ('" + lbl_TalepNo.Text + "', '" + txtTcNo.Text + "', '" + txtAciklama.Text + "'" +
                    "  ,'" + txtTarih.Text + "', '" + comboTalep.Text + "')";
